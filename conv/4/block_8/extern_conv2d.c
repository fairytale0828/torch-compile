...
int main(int argc, char *argv[])
{
    ...
    printf("memref_a: %p, memref_b: %p, memref_c: %p, memref_d: %p\n",
       memref_a, memref_b, memref_c, memref_d);
    ...
    _mlir_ciface_conv2d_kernel_0d1234c567c8d91011de12de1314c15d16d17e18e19de20de21e22c23c24c25c26c27c28c29c(
        ...
        (int64_t)(uintptr_t)memref_c, (int64_t)(uintptr_t)memref_d, 9, 8, 64, 64, 8
    );
