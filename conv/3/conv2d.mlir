...
module {
  func.func @conv2d_kernel_0d1234c567c8d91011de12de1314c15d16d17e18de19de20e21c22c23c24c25c26c27c28c(%arg0: i64, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i64, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32, %arg12: i64, %arg13: i64, %arg14: i32, %arg15: i32, %arg16: i32, %arg17: i32)attributes {llvm.emit_c_interface} {
    ...
    %12 = arith.muli %6, %arg15 : i32
    %13 = arith.muli %6, %arg16 : i32
    %14 = arith.muli %6, %arg17 : i32
    %15 = tensor.empty() : tensor<4xi32>
    %16 = scf.for %arg18 = %c0 to %c4 step %c1 iter_args(%arg19 = %15) -> (tensor<4xi32>) {
      %65 = arith.index_cast %arg18 : index to i32
      %inserted = tensor.insert %65 into %arg19[%arg18] : tensor<4xi32>
    ...
    scf.for %arg18 = %c0_i32 to %arg14 step %c1_i32  : i32 {
      %65 = arith.subi %arg18, %c1_i32 : i32
      ...
      // %83 = linalg_ext.gather dimension_map = [0] ranged_data(false) signed_indice(true) ins(%81, %expanded_22, %collapsed_23 : tensor<9223372036854775807xf32>, tensor<16x1xi32>, tensor<16xi1>) outs(%82 : tensor<16x1xf32>) {
      // ^bb0(%arg19: f32, %arg20: f32):
      //   linalg_ext.yield %arg19 : f32
      // } -> tensor<16x1xf32>
