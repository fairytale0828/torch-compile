module {
  ...
  llvm.func @triton__0d1d2_6(%arg0: i64, %arg1: i64, %arg2: i32) attributes {llvm.emit_c_interface} {
    %0 = llvm.mlir.constant(0.000000e+00 : f32) : f32
    %1 = llvm.mlir.constant(84 : index) : i64
  ...
  ^bb6:  // pred: ^bb4
    ...
    %95 = llvm.getelementptr %94[84] : (!llvm.ptr) -> !llvm.ptr, f32
  ...
  llvm.func @_mlir_ciface_triton__0d1d2_6(%arg0: i64, %arg1: i64, %arg2: i32) attributes {llvm.emit_c_interface} {
    llvm.call @triton__0d1d2_6(%arg0, %arg1, %arg2) : (i64, i64, i32) -> ()
    llvm.return
  }
}
