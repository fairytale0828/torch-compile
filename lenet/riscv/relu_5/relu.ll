...
define void @triton__0d1d2e_5(i64 %0, i64 %1, i32 %2) {
...
53:                                               ; preds = %44
  ...
  %61 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %60, i64 120, 3, 0
  %62 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %61, i64 1, 4, 0
  %63 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 120) to i64), i64 64))
  ...
  %72 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %71, i64 120, 3, 0
  %73 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %72, i64 1, 4, 0
  br label %74

74:                                               ; preds = %77, %53
  %75 = phi i64 [ %84, %77 ], [ 0, %53 ]
  %76 = icmp slt i64 %75, 120
...
85:                                               ; preds = %74
  ...
  %100 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %99, i64 120, 3, 0
  %101 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %100, i64 1, 4, 0
  call void @llvm.memcpy.p0.p0.i64(ptr %91, ptr %68, i64 mul (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 120), i1 false)
  ...
  %106 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %105, i64 120, 3, 0
  %107 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %106, i64 1, 4, 0
  br label %108

108:                                              ; preds = %111, %85
  %109 = phi i64 [ %118, %111 ], [ 0, %85 ]
  %110 = icmp slt i64 %109, 120
...
119:                                              ; preds = %108
  ...
  %134 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %133, i64 120, 3, 0
  %135 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %134, i64 1, 4, 0
  call void @llvm.memcpy.p0.p0.i64(ptr %125, ptr %68, i64 mul (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 120), i1 false)
  br label %136
...
159:                                              ; preds = %148
  ...
  %163 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %162, i64 120, 3, 0
  ...
  %168 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %167, i64 120, 3, 0
  %169 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %168, i64 1, 4, 0
  %170 = call ptr @llvm.stacksave()
  ...
  call void @llvm.stackrestore(ptr %170)
  ret void
}

define void @_mlir_ciface_triton__0d1d2e_5(i64 %0, i64 %1, i32 %2) {
  call void @triton__0d1d2e_5(i64 %0, i64 %1, i32 %2)
  ret void
}
