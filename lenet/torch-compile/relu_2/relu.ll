...
define void @triton__0d1d2de_2(i64 %0, i64 %1, i32 %2) {
  %4 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64), i64 64))
  ...
  %15 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64), i64 64))
  ...
  %24 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %23, i64 1024, 3, 0
...
32:                                               ; preds = %26
  %33 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i32, ptr null, i32 1024) to i64), i64 64))
  ...
  %42 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %41, i64 1024, 3, 0
  %43 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %42, i64 1, 4, 0
  %44 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i32, ptr null, i32 1024) to i64), i64 64))
...
61:                                               ; preds = %55
  %62 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i32, ptr null, i32 1024) to i64), i64 64))
  ...
  %71 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %70, i64 1024, 3, 0
...
102:                                              ; preds = %90
  %103 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i1, ptr null, i32 1024) to i64), i64 64))
  ...
  %112 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %111, i64 1024, 3, 0
...
120:                                              ; preds = %114
  %121 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i1, ptr null, i32 1024) to i64), i64 64))
  ...
  %130 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %129, i64 1024, 3, 0
...
138:                                              ; preds = %132
  ...
  %142 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %141, i64 1024, 3, 0
  %143 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %142, i64 1, 4, 0
  call void @llvm.memcpy.p0.p0.i64(ptr %126, ptr %108, i64 mul (i64 ptrtoint (ptr getelementptr (i1, ptr null, i32 1) to i64), i64 1024), i1 false)
  %144 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i32, ptr null, i32 1024) to i64), i64 64))
  ...
  %153 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %152, i64 1024, 3, 0
...
166:                                              ; preds = %155
  ...
  %174 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %173, i64 1024, 3, 0
  %175 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %174, i64 1, 4, 0
  %176 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64), i64 64))
  ...
  %185 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %184, i64 1024, 3, 0
  %186 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %185, i64 1, 4, 0
  br label %187

187:                                              ; preds = %190, %166
  %188 = phi i64 [ %197, %190 ], [ 0, %166 ]
  %189 = icmp slt i64 %188, 1024
...
198:                                              ; preds = %187
  %199 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64), i64 64))
  ...
  %208 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %207, i64 1024, 3, 0
  ...
  %213 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %212, i64 1024, 3, 0
  %214 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %213, i64 1, 4, 0
  call void @llvm.memcpy.p0.p0.i64(ptr %204, ptr %181, i64 mul (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 1024), i1 false)
  br label %215
...
233:                                              ; preds = %222
  ...
  %240 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64), i64 64))
  ...
  %249 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %248, i64 1024, 3, 0
...
266:                                              ; preds = %253
  ...
  %270 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %269, i64 1024, 3, 0
...
297:                                              ; preds = %274
  ...
  %311 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %310, i64 1024, 3, 0
  %312 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %311, i64 1, 4, 0
  br label %313

313:                                              ; preds = %316, %297
  %314 = phi i64 [ %323, %316 ], [ 0, %297 ]
  %315 = icmp slt i64 %314, 1024
...
336:                                              ; preds = %325
  ...
  %340 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %339, i64 1024, 3, 0
  ...
  %345 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %344, i64 1024, 3, 0
...
define void @_mlir_ciface_triton__0d1d2de_2(i64 %0, i64 %1, i32 %2) {
  call void @triton__0d1d2de_2(i64 %0, i64 %1, i32 %2)
  ret void
}
