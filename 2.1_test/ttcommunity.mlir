...
module {
  func.func @triton__0d1d2de(%arg0: i64, %arg1: i64, %arg2: i32) {
    ...
    %4 = scf.for %arg3 = %c0 to %c256 step %c1 iter_args(%arg4 = %3) -> (tensor<256xi32>) {
      %21 = arith.index_cast %arg3 : index to i32
      %inserted = tensor.insert %21 into %arg4[%arg3] : tensor<256xi32>
    ...
    %extracted = tensor.extract %4[%c0] : tensor<256xi32>
    ...
    %inserted_slice = tensor.insert_slice %15 into %17[0] [%9] [1] : tensor<?xf32> into tensor<256xf32>
    ...
    %20 = linalg.fill ins(%19 : f32) outs(%16 : tensor<256xf32>) -> tensor<256xf32>
    %mapped = linalg.map { arith.addf } ins(%inserted_slice, %20 : tensor<256xf32>, tensor<256xf32>) outs(%16 : tensor<256xf32>)
    %view_memref_1 = aux.view %12 to offset: [%11], sizes: [%9], strides: [1] : !llvm.ptr to memref<?xf32, #map>
    %extracted_slice = tensor.extract_slice %mapped[0] [%9] [1] : tensor<256xf32> to tensor<?xf32>
