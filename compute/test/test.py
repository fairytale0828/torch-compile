...
# buf1 = torch.randn(3456, device='cuda:0')
buf1 = torch.linspace(-59, 60, 3456, device='cuda', dtype=torch.float32)
# print(buf1)
# primals_2 = torch.ones(3456, device='cuda:0')
primals_2 = torch.linspace(-59, 60, 3456, device='cuda', dtype=torch.float32)
